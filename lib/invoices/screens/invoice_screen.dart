                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                          'Document Type: ${invoice['operador']['tipo_documento']}'),
                      Text('Document: ${invoice['operador']['documento']}'),
                      Text(
                          'Document Issuance City: ${invoice['operador']['ciudad_expedicion_documento']}'),
                      Row(children: [
                      ...
                      Text(
                          'Bank Account Number: ${invoice['operador']['numero_cuenta_bancaria']}'),
                      Text(
                          'Bank Account Type: ${invoice['operador']['tipo_cuenta_bancaria']}'),
                      const SizedBox(height: 16),
                      const Text(
                        'Services',
                        style: TextStyle(
                        ...
                        Column(
                            ...
                            children: [
                              Row(children: [
                                ...
                                Expanded(
                                  child: Text(
                                      invoice['servicios'][i]['descripcion']),
                                ),
                              ]),
                              Row(children: [
                                const Icon(Icons.attach_money),
                                const SizedBox(width: 8),
                                Text(invoice['servicios'][i]['valor']
                                    .toString()),
                              ])
                            ]),
                    ],
